...
public class BnUdpTelaClienteChat extends javax.swing.JFrame implements BnUdpServerProtcocolInterface, BnUdpClientProtocolInterface {
    ...
    private void bEnviarMensagemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEnviarMensagemActionPerformed
    	 ...
    	 * 
    	 */
    	String data = BnUdpMessengerClient.SEND_MESSAGE+"#";
    	    	
    	if(tTodos.isSelected()){
    		data += BROADCAST_MSG+"#"+nickname+"#"+tMensagem.getText();
    	}else if(!tDestinatario.getText().isEmpty()){
    		data += tDestinatario.getText()+"#"+nickname+"#"+tMensagem.getText();
    	}else{
    		JOptionPane.showMessageDialog(null, "Digite um destinatario");
    	}
    ...
    private void bLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bLoginActionPerformed
        ...
        if (nickname.contains(simbolosProibidos))
    ...
    public javax.swing.JTextArea gettChat() {
		return tChat;
	}

	public void settChat(javax.swing.JTextArea tChat) {
		this.tChat = tChat;
	}
